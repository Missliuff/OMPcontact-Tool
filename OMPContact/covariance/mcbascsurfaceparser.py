...
for each in filelist:
    ...
    mcbascsurface[proteinid]=surfaceresult
    '''
    ...
    for key,value in result:
        ...
        row = row + 1
    w.save('/home/songjz671/covariancesurfaceout/mcbasc/'+proteinid+'.xls')    
    #print(pointresult)
    '''
outfile=open('/home/songjz671/covariancesurfaceout/mcbascsurface.pickle','wb')
pickle.dump(mcbascsurface,outfile)
