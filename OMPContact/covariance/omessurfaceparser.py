...
for each in filelist:
    ...
    omessurface[proteinid]=surfaceresult
    '''
    ...
    for key,value in result:
        ...
        row = row + 1
    w.save('/home/songjz671/covariancesurfaceout/omes/'+proteinid+'.xls')    
    #print(pointresult)
    '''
outfile=open('/home/songjz671/covariancesurfaceout/omessurface.pickle','wb')
pickle.dump(omessurface,outfile)
